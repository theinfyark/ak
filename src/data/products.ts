...
export const productsCatalog: Product[] = [
  ...
  },
  {
    ...
    npmVersion: '1.1.3',
    description:
      'Interactive CLI to scaffold production-ready Node.js backends — Express, Fastify, Hono, Koa, TypeScript, Zod, Prisma, Docker, and CI.',
    tags: ['cli', 'scaffold', 'backend', 'generator'],
    github: gh('node-gen-kit'),
    npm: npm('node-gen-kit'),
  },
  {
    id: 'env-ok-kit',
    name: 'env-ok-kit',
    ...
    github: gh('env-ok-kit'),
    npm: npm('env-ok-kit'),
  },
  {
    id: 'docker-health-kit',
    name: 'docker-health-kit',
    group: 'library',
    status: 'live',
    language: 'TypeScript',
    npmVersion: '1.0.3',
    ...
    github: gh('docker-health-kit'),
    npm: npm('docker-health-kit'),
  },
  {
    id: 'ai-cost-insight',
